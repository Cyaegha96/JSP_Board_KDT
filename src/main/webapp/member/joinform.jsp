...
<body>
    <div class="joinform_container card border-primary m-auto" style="width: 80%;">
        <div class="header card-header bg-primary d-flex justify-content-center text-white">
           <h6> 회원가입 정보 입력</h6>
        </div>
        <form id="joinForm" action="/login.member" class="card-body needs-validation" method="post" novalidate>
        <div class="row g-3 m-2">
				...
				<div class="col-sm-3">
					<button id="IdDupliCheck" type="button" class="btn btn-primary col-form-btn">
						중복확인</button>
				</div>
		</div>	
		<div class="row g-3 m-2">
				<label for="inputPW" class="col-sm-2 col-form-label text-start text-sm-end">PW</label>
				<div class="col-sm-6">
		...
		<div class="row g-3 m-2">
				<label for="inputPWCorrect" class="col-sm-2 col-form-label text-start text-sm-end">PW 확인</label>
				<div class="col-sm-6">
    ...
    $("#reset").click(function(){
    		...
    		$("input").val("");
    		$("#inputId, #inputPW, #inputPWCorrect, #inputPhone, #inputName").css({"border" : "2px solid red"})
    ...
    $("#IdDupliCheck").click(function(){
    	...
    	window.open("/idcheck.member?id="+$('#inputId').val(), "", "width=350, height=200")
    });
