...
<body>
	<c:choose>
		...
		<table border="1" class="table text-center">
			...
			<tr>
			<td><a href="/chat.jsp" class="text-decoration-none text-black fw-bold">채팅 페이지</td>
				<td><a href="/game/exam03.html" class="text-decoration-none text-black fw-bold">시안 2 페이지</td>
