			...
			<form id="writeBoardFrm" action="/insert.board" method="post">
				<table
					...
					<tbody>
						...
						<tr>
							<td class="text-start" width="80%"><input id="inputTitle"
								name="title" type="text" placeholder="글 제목을 입력하세요" class="w-100">
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="5" class="text-end"><input type="hidden"
								name="content" id="hiddenContent"> <a
								href="/list.board?cpage=1"><button type="button">목록으로</button></a>
								<a><button type="submit" id="submitbtn">작성완료</button></a></td>
						</tr>
